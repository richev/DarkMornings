...
namespace Richev.DarkMornings.Core
{
    public static class TimeZones
    {
        ...
        /// From http://stackoverflow.com/a/6144229/39709
        /// </remarks>
        public static string OlsonTimeZoneToTimeZoneInfo(string olsonTimeZoneId)
        {
            // Pretty sure that most of these will never be used...
            var olsonWindowsTimes = new Dictionary<string, string>
            {
                { "Atlantic/Stanley", "Argentina Standard Time" }, // probably technically not!
                ...
                { "Europe/Uzhgorod Europe/Zaporozhye", "FLE Standard Time" },
            ...
            if (olsonWindowsTimes.ContainsKey(olsonTimeZoneId))
            {
                windowsTimeZoneId = olsonWindowsTimes[olsonTimeZoneId];
            }
